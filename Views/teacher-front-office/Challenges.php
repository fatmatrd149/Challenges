...
<title>Challenges Dashboard - Teacher</title>
...
<main class="container py-5">
    <div class="dashboard-header text-center">
        ...
        <p class="text-light mb-0 fs-5">Manage challenges for your students</p>
    </div>

    <div class="row mb-4">
        <div class="col-md-4">
            <div class="stats-card">
                <i class="fas fa-tasks mb-3" style="font-size: 2.5rem; color: #2563eb;"></i>
                <div style="font-size: 2.2rem; font-weight: 700; color: #111827;">
                    <?= count($challenges) ?>
                </div>
                <small class="text-muted">Your Challenges</small>
            </div>
        </div>
        <div class="col-md-4">
            <div class="stats-card">
                <i class="fas fa-clock mb-3" style="font-size: 2.5rem; color: #dc2626;"></i>
                <div style="font-size: 2.2rem; font-weight: 700; color: #111827;">
                    <?= count($teacherTimeLimited) ?>
                </div>
    ...
    <div class="feature-section">
        <h4><i class="fas fa-clock me-2"></i>Your Time-Limited Challenges</h4>
        <div class="row g-3">
    ...
    <?php if (!empty($teacherRecurring)): ?>
    <div class="feature-section">
        <h4><i class="fas fa-sync-alt me-2"></i>Your Recurring Challenges</h4>
        <div class="row g-3">
            <?php foreach ($teacherRecurring as $challenge): ?>
                <div class="col-md-6">
                    <div class="challenge-card">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <h6 class="fw-bold mb-0"><?= htmlspecialchars($challenge['title']) ?></h6>
...
<div id="challengeForm" class="form-modal" <?= ($edit_challenge || $form_data) ? 'style="display: block;"' : '' ?>>
    <div class="form-container">
        ...
        <form id="challengeFormData" action="../../Controllers/ChallengesController.php?<?= $edit_challenge ? 'action=update&id=' . $edit_challenge['id'] : 'action=create' ?>" method="POST">
            ...
            <input type="hidden" name="createdBy" value="<?= $teacherID ?>" />
            
            <div class="row">
                <div class="col-md-8">
                    <div class="mb-3">
                        <label class="form-label fw-semibold required-field">Challenge Title</label>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        <label class="form-label fw-semibold required-field">Points</label>
            ...
            <div class="mb-4">
                <label class="form-label fw-semibold required-field">Description</label>
            ...
            <div class="mb-4">
                ...
                <input type="text" id="criteria" name="criteria" class="form-control" value="<?= 
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    <select id="schedule_type" name="schedule_type" class="form-control">
                        ...
                        <option value="time_limited" <?= ($edit_challenge && $edit_challenge['schedule_type'] == 'time_limited') || ($form_data && ($form_data['schedule_type'] ?? '') == 'time_limited') ? 'selected' : '' ?>>Time-Limited Challenge</option>
                        <option value="recurring" <?= ($edit_challenge && $edit_challenge['schedule_type'] == 'recurring') || ($form_data && ($form_data['schedule_type'] ?? '') == 'recurring') ? 'selected' : '' ?>>Recurring Challenge</option>
                    </select>
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-semibold">Time Limit (minutes)</label>
                    <input type="text" id="time_limit_minutes" name="time_limit_minutes" class="form-control" value="<?= 
            ...
            <div class="row mb-4" id="dateFields" style="<?= 
            ...
            <div class="mb-4" id="recurrenceField" style="<?= 
            ...
            ?>">
                <label class="form-label fw-semibold">Recurrence Pattern</label>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6">
                    <label class="form-label fw-semibold">Tree Order</label>
            ...
            <div class="d-flex justify-content-end gap-3">
                <button type="button" onclick="hideForm()" class="btn btn-outline-secondary px-4">
                    Cancel
                </button>
...
function editChallenge(id) {
    window.location.href = '../../Controllers/ChallengesController.php?action=get&id=' + id;
}

function deleteChallenge(id) {
    if (confirm('Are you sure you want to delete this challenge?')) {
        window.location.href = '../../Controllers/ChallengesController.php?action=delete&id=' + id;
    }
}
